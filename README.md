...
《开物脉络》以「同一道造物问题的古今不同解法」为文化主线，将取材、控火、提纯、成形、控性等冶金过程组织为可交互的工艺认知网络。地域基底为凤凰山古铁冶遗存、《天工开物》地方文化关联与当代新余钢铁产业链。
...
├── 《开物脉络》天工开物杯项目执行计划与技术设计文档.docx
├── 《开物脉络》深度研究与技术设计文档.pdf
...
```bash
# 1. 构建前端
cd kaiwu-mailuo/frontend && npm install && npm run build
...
更多运行细节（开发模式热更新、板面重新渲染等）见 [kaiwu-mailuo/README.md](kaiwu-mailuo/README.md)。
...
- [项目运行与设计原则详情](kaiwu-mailuo/README.md)
- [投稿清单与设计说明](kaiwu-mailuo/docs/投稿清单与设计说明.md)
- [A/B 测试工具包](kaiwu-mailuo/docs/AB测试工具包.md)
