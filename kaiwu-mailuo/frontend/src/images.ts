...
export const NODE_IMAGES: Record<string, ImgMeta> = {
  ...
  M2: { src: IMG('m2'), credit: '新钢厂区 · 印象新钢工业旅游（央视网配图）', license: '媒体配图 · 演示用途', page: 'https://local.cctv.com/2023/10/25/ARTI8dWM4uos18x2iyvJxDal231025.shtml' },
  ...
  M6: { src: IMG('m6'), credit: '新钢 · 青花瓷冷却塔（央视网配图）', license: '媒体配图 · 演示用途', page: 'https://local.cctv.com/2023/10/25/ARTI8dWM4uos18x2iyvJxDal231025.shtml' },
}

export const HERO_SLIDES: { src: string; eyebrow: string; title: string; tab: 'walk' | 'craft' | 'spectrum'; credit: string; license: string }[] = [
  { src: IMG('hero1'), eyebrow: '研学基地 · 江西新余', title: '一块铁 · 近四百年', tab: 'walk', credit: '新钢厂区航拍 · 央视网', license: '媒体配图 · 演示用途' },
...
export const FALLBACK_IMG: ImgMeta = { src: IMG('m2'), credit: '新钢厂区 · 央视网配图', license: '媒体配图 · 演示用途', page: 'https://local.cctv.com/2023/10/25/ARTI8dWM4uos18x2iyvJxDal231025.shtml' }
