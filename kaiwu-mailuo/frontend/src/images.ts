...
export const IMG_META: Record<string, ImgMeta> = {
  ...
  m1: { src: IMG('m1'), credit: '露天采矿 · 现代采选作业（示意）', license: 'CC BY-SA 3.0', page: CP('File:Twincreeksblast.jpg') },
  m2: { src: IMG('m2'), credit: '新钢厂区 · 彩绘料仓实拍', license: '演示用途', page: CCTV },
  m3: { src: IMG('m3'), credit: '转炉炼钢 · 车间吹炼现场（示意）', license: 'CC BY-SA 3.0', page: CP('File:ThyssenKrupp Duisburg 016.jpg') },
  m4: { src: IMG('m4'), credit: '连铸产线 · 钢水铸坯（示意）', license: 'CC BY-SA 4.0', page: CP('File:ECSC Financial report 1995 Dillinger Hütte Continuous casting.jpg') },
  m5: { src: IMG('m5'), credit: '热轧机组 · 两辊可逆轧机', license: '公有领域 · NARA 541179', page: 'https://commons.wikimedia.org/w/index.php?search=NARA+541179+hot+roll' },
  m6: { src: IMG('m6'), credit: '新钢 · 青花瓷冷却塔实拍', license: '演示用途', page: CCTV },
  site: { src: IMG('site'), credit: '凤凰山铁矿遗址 · 露天采矿遗迹', license: '官网配图 · 演示用途', page: MUSEUM },
  museum: { src: IMG('museum'), credit: '新余市博物馆 · 馆名石刻', license: '官网配图 · 演示用途', page: MUSEUM },
  hero1: { src: IMG('hero1'), credit: '新钢厂区航拍 · 袁河与冷却塔', license: '演示用途', page: CCTV },
  hero2: { src: IMG('hero2'), credit: '出铁时刻 · 转炉车间', license: 'CC BY-SA 4.0', page: CP('File:Práce na martinské peci.jpg') },
